...
import { LogIn, UserPlus, Shield, AlertTriangle, Sun, Moon } from 'lucide-react';
...
export default function Login({ onLogin, dark, onToggleTheme, serverUrl, onOpenServerConfig }: LoginProps) {
    ...
    <div className="min-h-screen flex items-center justify-center p-4 relative overflow-hidden si-grid-bg"
      ...
      <div className="w-full max-w-md relative z-10">
        ...
        <div className="text-center mt-4 flex items-center justify-center gap-3">
          ...
          {onOpenServerConfig && (
            <button onClick={onOpenServerConfig} className="text-[9px] tracking-widest underline underline-offset-2 transition-colors"
              style={{ color: 'var(--text-accent)' }}>
              SERVER
            </button>
          )}
